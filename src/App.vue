...
const fonts: Font[] = [
  ...
  { name: 'DM Mono', family: 'DM Mono', mood: '精準、技術感', category: '等寬字體', clue: '每個字母佔相同寬度，排列整齊像程式碼。', use: '程式碼、數據、技術介面' }, { name: 'Fraunces', family: 'Fraunces', mood: '溫暖、有表現力', category: '襯線字體', clue: '字形柔和、粗細變化自然，比較像手工甜點包裝，而不是精品時尚雜誌。', use: '溫暖、手工的食品包裝' },
  ...
  { name: 'Pacifico', family: 'Pacifico', mood: '輕鬆、陽光', category: '手寫字體', clue: '連筆流暢，像用筆寫出的簽名，個性很強。', use: '餐飲、婚禮、休閒品牌' }, { name: 'Playfair Display', family: 'Playfair Display', mood: '經典、精緻', category: '襯線字體', clue: '字形精緻銳利、粗細反差明顯，容易讓人想到精品時尚雜誌。', use: '精緻、時尚的精品品牌' },
...
const rounds = [
  { question: '哪個適合科技新創？', hint: '產品標題需要有個性，但仍然要清楚好讀。', translation: 'Best for a bold, readable tech product?', target: 'Space Grotesk', options: ['Space Grotesk', 'Unbounded'] },
  ...
  { question: '哪個適合生活 App？', hint: '介面需要讓第一次使用者感到輕鬆。', translation: 'Best for an easygoing lifestyle app?', target: 'Manrope', options: ['Manrope', 'Cormorant Garamond'] },
